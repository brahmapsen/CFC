                        ...
                        <div className={styles.create}>
                            <div className={styles.create__grid}>
                                    <div className={styles.create__grid_left}>
                                      ...
                                      <br/>
                                      <label htmlFor="clinicalTrialReserchAgency">Clinical Trial Research Agency: </label>  &nbsp;&nbsp;
                                      <input
                        ...
                        <div className={styles.create}>
                                <div className={styles.create__grid}>
                                  <div className={styles.create__grid_left}>
                                    ...
                                    <label htmlFor="fundingFlow">Funding Flow: </label> &nbsp;&nbsp; {fundingFlow}<br/>
                                    <label htmlFor="SenderAddress">Sender Address: </label>&nbsp;&nbsp;{senderAddress}<br/>
                                    <label htmlFor="receiverAddress">Receiver Address: </label>&nbsp;&nbsp;{receiverAddress}
                                  </div>
                                </div>
                        </div>
